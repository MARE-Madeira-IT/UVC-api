...
class MareReportRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'site_id' => 'required|exists:mare_sites,id',
            'depth_id' => 'integer|exists:mare_depths,id',
            'project_id' => 'integer|exists:mare_projects,id',
            ...
            'functions.*.function_id' => 'required|integer|exists:mare_functions,id',
