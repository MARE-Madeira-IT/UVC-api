...
class MareBenthicRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'benthics.*.taxa_id.1' => 'nullable|integer|exists:mare_taxas,id',

            'benthics.*.p' => 'required|integer|min:1|max:100',
            'benthics.*.substrate_id' => 'required|integer|exists:mare_substrates,id',
